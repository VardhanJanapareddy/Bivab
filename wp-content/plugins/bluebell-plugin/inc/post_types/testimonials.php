...
namespace BLUEBELLPLUGIN\Inc\Post_Types;

use BLUEBELLPLUGIN\Inc\Abstracts\Post_Type;
 ...
 *
 * @version  2.6.0
 * @package  BLUEBELLPLUGIN/Abstracts
...
class Testimonials extends Post_Type {
	...
	public static function init() {
		...
		self::instance()->singular  = esc_html__( 'Testimonial', 'wpbluebell' );
		self::instance()->plural    = esc_html__( 'Testimonials', 'wpbluebell' );
