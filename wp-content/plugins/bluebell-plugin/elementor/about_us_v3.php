...
class About_Us_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'About Us V3', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'about_us_v3',
			[
				'label' => esc_html__( 'About US V3', 'bluebell' ),
			]
		);
		$this->add_control(
			'image',
		...
		$this->add_control(
			'text3',
			[
				'label'       => __( 'Text 3', 'bluebell' ),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => [
					'active' => true,
				],
				'placeholder' => __( 'Enter your Text 3', 'bluebell' ),
			]
		);
		$this->add_control(
			'sign',
    ...
    <section class="Welcome-section">
        <div class="auto-container">
            <div class="row">
                ...
                <div class="col-lg-6 Welcome-block">
                ...
                <div class="col-lg-6 Welcome-block">
                    ...
                    <?php if($settings['title']){ ?><div class="sec-title text-light"><?php echo wp_kses($settings['title'], true); ?></div><?php } ?>
                    ...
                    <?php if($settings['sign']){ ?><div class="image"><img src="<?php echo esc_url(wp_get_attachment_url($settings['sign']['id'])); ?>" alt="<?php esc_attr_e('Awesome Image', 'bluebell'); ?>"></div><?php } ?>
                </div>
            </div>
        </div>
    </section>
