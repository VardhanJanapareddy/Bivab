...
class Our_Rooms_V1 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Rooms V1', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_rooms_v1',
			[
				'label' => esc_html__( 'Our Rooms V1', 'bluebell' ),
			]
		);
		$this->add_control(
			'subtitle',
	...
	<!-- room section -->
    <section class="room-section <?php if($settings['style_two'] == 'two') echo 'light-bg mx-60 border-shape-top'; else echo ''; ?>">
        <div class="auto-container">
            <div class="top-content">
                <?php if($settings['subtitle'] || $settings['title']) {?>
                <div class="title-box <?php if($settings['style_two'] == 'two') echo ''; else echo 'text-light'; ?>">
                ...
                <div class="right-column">
                    <?php if($settings['text']) {?><div class="<?php if($settings['style_two'] == 'two') echo 'text-two'; else echo 'text'; ?>"><?php echo wp_kses( $settings['text'], true );?></div><?php } ?>
            ...
            <div class="row">
				...
				?>
                <div class="room-block <?php if(get_post_meta( get_the_id(), 'room_dimension', true) == 'extra_width') echo 'col-lg-8'; else echo 'col-lg-4'?>">
                    <div class="inner-box">
                        <a href="<?php echo esc_url(get_permalink(get_the_id()));?>">
                        <div class="image">
							<?php 
								$room_dimension = get_post_meta( get_the_id(), 'room_dimension', true );
								if($room_dimension == 'extra_width'){
									$image_size = 'bluebell_770x374';
								}
								else{
									$image_size = 'bluebell_370x374'; 
								}
