...
class Our_Gallery_V1 extends Widget_Base {
	...
	public function get_name() {
		return 'bluebell_our_gallery_v1';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Gallery V1', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_gallery_v1',
			[
				'label' => esc_html__( 'Our Gallery V1', 'bluebell' ),
			]
		);
		$this->add_control(
			'number',
	...
	protected function render() {
		...
		<?php 
            ...
            <!-- Gallery Block -->
            <div class="gallery-block-four gallery-overlay masonry-item all <?php echo esc_attr($term_slug); ?> col-lg-4 col-md-6">
                <div class="inner-box">
                    <div class="image">
                    ...
                    <div class="overlay-box">
                        <div class="overlay-inner">
                            <div class="content">
                                <a href="<?php echo esc_url($post_thumbnail_url); ?>" class="lightbox-image link" data-fancybox="galleryone"><span class="icon fas fa-eye"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
