 ...
 * @since 1.0.0
 */
class Our_Rooms_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Rooms V3', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_rooms_v3',
			[
				'label' => esc_html__( 'Our Rooms V3', 'bluebell' ),
			]
		);
		$this->add_control(
			'subtitle',
    ...
    <!-- room section two -->
    <section class="room-section-two light-bg mx-60 border-shape-top">
        <div class="auto-container">
            ...
            <div class="theme_carousel owl-theme owl-carousel owl_nav_style_one" data-options='{"loop": true, "center": false, "margin": 130, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 1000, "responsive":{ "0" :{ "items": "1" }, "480" :{ "items" : "1" }, "600" :{ "items" : "1" }, "768" :{ "items" : "1", "margin": 30 } , "992":{ "items" : "2", "margin": 30 }, "1200":{ "items" : "2", "margin": 130 }}}'>
                <?php 
                ...
                <div class="room-block-two">
                    ...
                    <div class="link-btn"><a href="<?php echo esc_url(get_permalink(get_the_id()));?>" class="theme-btn btn-style-one btn-md"><span><?php esc_html_e('room details', 'bluebell')?></span></a></div>
                </div>
                <?php endwhile;?>
            </div>
        </div>
