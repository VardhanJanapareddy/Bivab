 ...
 * @since 1.0.0
 */
class Spa_Wellness extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Spa Wellness', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'spa_wellness',
			[
				'label' => esc_html__( 'Spa Wellness', 'bluebell' ),
			]
		);
		$this->add_control(
			'sub_title',
	...
	<!-- holetic section -->
    <section class="holetic-section light-bg mx-60 border-shape-top">
        <div class="auto-container">
            <div class="row">
                ...
                <?php } ?>
                <?php if($settings['image2']['id'] || $settings['image3']['id']){ ?>
                <div class="col-lg-4">
                    ...
                    <?php if($settings['image3']['id']){ ?><div class="image-two"><img src="<?php echo esc_url(wp_get_attachment_url($settings['image3']['id'])); ?>" alt="<?php esc_attr_e('Awesome Image', 'bluebell'); ?>"></div><?php } ?>
                </div>
                <?php } ?>
            </div>
        </div>
