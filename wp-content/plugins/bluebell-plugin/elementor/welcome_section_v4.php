 ...
 * @since 1.0.0
 */
class Welcome_Section_V4 extends Widget_Base {
	...
	public function get_name() {
		return 'bluebell_welcome_section_v4';
	}
	...
	public function get_title() {
		return esc_html__( 'Welcome Section V4', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'welcome_section_v4',
			[
				'label' => esc_html__( 'Welcome Section V4', 'bluebell' ),
			]
		);
		$this->add_control(
			'image',
		...
		$this->add_control(
			'bold_text',
			[
				'label'       => __( 'Bold Text', 'bluebell' ),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => [
					'active' => true,
				],
				'placeholder' => __( 'Enter Bold text', 'bluebell' ),
			]
		);
		$this->add_control(
			'text',
		...
		$this->add_control(
			'text3',
			[
				'label'       => __( 'Text V3', 'bluebell' ),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => [
					'active' => true,
				],
				'placeholder' => __( 'Enter your Text V3', 'bluebell' ),
			]
		);
		$this->add_control(
			'sign_image',
			[
			  'label' => __( 'sign_image', 'bluebell' ),
			  'type' => Controls_Manager::MEDIA,
			  'default' => ['url' => Utils::get_placeholder_image_src(),],
			]
		);
    ...
    <section class="welcome-section-four light-bg mx-60 border-shape-top">
        <div class="auto-container">
            <div class="row">
               <div class="col-lg-6">
                   <div class="inner-box">
                       <?php if($settings['image']['id']){ ?><div class="image" style="background-image: url(<?php echo esc_url(wp_get_attachment_url($settings['image']['id'])); ?>);"><img src="<?php echo esc_url(wp_get_attachment_url($settings['image']['id'])); ?>" alt="<?php esc_attr_e('Awesome Image', 'bluebell'); ?>"></div><?php } ?>
                       <div class="content">
                           <?php if($settings['bold_text']){ ?><div class="text"><?php echo wp_kses($settings['bold_text'], true); ?> </div><?php } ?>
               ...
               <div class="col-lg-6">      
                   <div class="right-column mt_90">
                       ...
                       <?php if($settings['text2']){ ?><div class="text-three"><?php echo wp_kses($settings['text2'], true); ?> </div><?php } ?>
                       <?php if($settings['text3']){ ?><div class="text-four"><?php echo wp_kses($settings['text3'], true); ?> </div><?php } ?>
