 ...
 * @since 1.0.0
 */
class Eat_And_Drink extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Eat_And_Drink', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'eat_and_drink',
			[
				'label' => esc_html__( 'Eat_And_Drink', 'bluebell' ),
			]
		);
		$this->add_control(
			'image1',
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="image-block">
                        ...
                        <div class="image"><img src="<?php echo esc_url(wp_get_attachment_url($settings['image1']['id'])); ?>" alt="<?php esc_attr_e('Awesome Image', 'bluebell'); ?>"></div>
                        <?php } ?>
						
						<?php if($settings['image2']['id']){ ?>
                        <div class="text-end">
                            <div class="image-two img_hover_1"><img src="<?php echo esc_url(wp_get_attachment_url($settings['image2']['id'])); ?>" alt="<?php esc_attr_e('Awesome Image', 'bluebell'); ?>"></div>
                        </div>
                        <?php } ?>
                        
						<?php if($settings['text1']){ ?><div class="text-one"><?php echo wp_kses($settings['text1'], true); ?></div><?php } ?>
                ...
                <div class="col-lg-6">
                    <div class="content-block">
                        ...
                        <?php } ?>
                        <?php if($settings['time']){ ?><div class="time"><?php echo wp_kses($settings['time'], true); ?></div><?php }?>
