...
class Testimonials_V3 extends Widget_Base {
	...
	public function get_name() {
		return 'bluebell_testimonials_v3';
	}
	...
	public function get_title() {
		return esc_html__( 'Testimonials V3', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'testimonials_v3',
			[
				'label' => esc_html__( 'Testimonials V3', 'bluebell' ),
			]
		);
		$this->add_control(
			'sub_title',
		...
		$this->add_control(
			'show_author',
			[
				'label' => __( 'Hide/Show Author Info', 'sanito' ),
				'type' => Controls_Manager::SWITCHER,
				'title' => esc_html__('Enable/Disable Author Info', 'sanito'),
				'default' => true,
			]
		);
		$this->add_control(
			'style_two',
			[
				'label'   => esc_html__( 'Choose Different Style', 'sanito' ),
				'label_block' => true,
				'type'    => Controls_Manager::SELECT,
				'default' => 'one',
				'options' => array(
					'one' => esc_html__( 'Show Carousel Testimonials', 'sanito' ),
					'two' => esc_html__( 'Show without Carousel Testimonials ', 'sanito' ),
				),
			]
		);
		$this->add_control(
    ...
    <section class="testimonials-section-three mx-60 light-bg border-shape-top">
        <div class="auto-container">
            <div class="title-box mb_60">
                <div class="sub-title"><?php echo wp_kses($settings['sub_title'], $allowed_tags); ?></div>
                <h2 class="sec-title mb-30"><?php echo wp_kses($settings['title'], $allowed_tags); ?></h2>
   ...
   <?php else: ?>
    ...
    <section class="testimonials-section-two light-bg mx-60 border-shape-top">
        <div class="auto-container">
            <div class="sub-title"><?php echo wp_kses($settings['sub_title'], $allowed_tags); ?></div>
            <h2 class="sec-title mb-30"><?php echo wp_kses($settings['title'], $allowed_tags); ?></h2>
            <div class="title-desc mb_60"><?php echo wp_kses($settings['text'], $allowed_tags); ?></div>
            <div class="row">
                <?php while ( $query->have_posts() ) : $query->the_post(); ?>
                <div class="col-lg-6">
                    <div class="testimonial-block style-two">                                
