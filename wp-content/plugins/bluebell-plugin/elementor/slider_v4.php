...
class Slider_V4 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider V4', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'slider_v4',
			[
				'label' => esc_html__( 'Slider V4', 'bluebell' ),
			]
		);
		$this->add_control(
             'slides', 
                    ...
                    <div class="content-outer">
                        <div class="content-box justify-content-center">
                            <div class="inner text-center">
                                ...
                                <?php if($item['btn_title']){ ?><div class="link-btn"><a href="<?php echo esc_url($item['btn_link']['url']);?>" class="theme-btn btn-style-four"><?php echo wp_kses($item['btn_title'], true);?> <i class="flaticon-right-arrow"></i></a></div><?php } ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="check-availability">
        <div class="auto-container">
            <div class="form">
            	<?php echo do_shortcode($settings['booking_form_url4']); ?>
            </div>
        </div>
    </div>        
    <?php endif; ?>   
