...
class About_Us_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'About Us V2', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'about_us_v2',
			[
				'label' => esc_html__( 'About US V2', 'bluebell' ),
			]
		);
		$this->add_control(
			'sub_title',
		...
		$this->add_control(
			 'show_features_list',
			[
				'label'       => __( 'Enable/Disable features_list', 'bluebell' ),
 ...
 <!-- About Section -->
    <section class="about-section light-bg mx-60 border-shape-top">
        <div class="auto-container">
            <div class="row">
                <div class="col-lg-6 content-block">
                    ...
                    <?php if($settings['show_features_list']):?>
                    <div class="icon-list">
