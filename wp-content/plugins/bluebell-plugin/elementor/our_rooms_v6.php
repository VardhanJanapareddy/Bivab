 ...
 * @since 1.0.0
 */
class Our_Rooms_V6 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Rooms V6', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_rooms_v6',
			[
				'label' => esc_html__( 'Our Rooms V6', 'bluebell' ),
			]
		);
		$this->add_control(
			'subtitle',
    ...
    <section class="accomodation-section nav-style-two style-two light-bg mx-60 border-shape-top">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="content-box">
                                    <h3><a href="<?php echo esc_url(get_permalink(get_the_id()));?>"><?php the_title(); ?> <?php esc_html_e('/', 'bluebell'); ?></a></h3>
