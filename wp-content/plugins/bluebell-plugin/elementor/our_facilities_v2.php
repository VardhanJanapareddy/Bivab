 ...
 * @since 1.0.0
 */
class Our_Facilities_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'bluebell_our_facilities_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Facilities V2', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_facilities_v2',
			[
				'label' => esc_html__( 'Our Facilities V2', 'bluebell' ),
			]
		);
		$this->add_control(
			'sub_title',
