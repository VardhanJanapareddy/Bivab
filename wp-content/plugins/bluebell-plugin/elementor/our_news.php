 ...
 * @since 1.0.0
 */
class Our_News extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our_News', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_news',
			[
				'label' => esc_html__( 'Our_News', 'bluebell' ),
			]
		);
		$this->add_control(
			'sub_title',
    ...
    <section class="news-section pt-0 light-bg mx-60 border-shape-bottom">
        <div class="auto-container">
            ...
            <div class="title-box text-center">
                ...
                <h2 class="sec-title"><?php echo wp_kses($settings['title'], true); ?></h2>
            </div>
            <?php } ?>
            <div class="row">
