...
class Banner_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Banner V2', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'banner_v2',
			[
				'label' => esc_html__( 'Banner V2', 'bluebell' ),
			]
		);
		$this->add_control(
			'bg_image',
    ...
    <section class="banner-section-three style-two">
        <div class="wrapper-box" <?php if($settings['bg_image']['id']){ ?>style="background-image: url(<?php echo esc_url(wp_get_attachment_url($settings['bg_image']['id'])); ?>);"<?php } ?>>
