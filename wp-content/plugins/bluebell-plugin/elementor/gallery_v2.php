...
class Gallery_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Gallery_V2', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'gallery_v2',
			[
				'label' => esc_html__( 'Gallery V2', 'bluebell' ),
			]
		);
		$this->add_control(
			'sub_title',
	...
	{ ?>
  	...
  	<!-- gallery section -->
    <section class="gallery-section light-bg mx-60 border-shape-top">
        <div class="auto-container">
            ...
            <?php } ?>
          	<div class="row">
				...
				?>
                <div class="col-lg-4 col-md-6 gallery-block">
                    <div class="image gallery-overlay b-radius-8">
                        <div class="inner-box">
                            <?php the_post_thumbnail('bluebell_370x350'); ?>
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <div class="content">
                                        <a href="<?php echo esc_url($post_thumbnail_url); ?>" class="lightbox-image link" data-fancybox="gallerytwo"><span class="icon fas fa-eye"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
