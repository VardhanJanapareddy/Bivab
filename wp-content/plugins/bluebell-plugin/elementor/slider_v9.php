 ...
 * @since 1.0.0
 */
class Slider_V9 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider V9', 'bluebell' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'slider_v9',
			[
				'label' => esc_html__( 'Slider V9', 'bluebell' ),
			]
		);
		$this->add_control(
             'slides', 
                        ...
                        <div class="content-outer">
                            <div class="content-box">
                                <div class="inner">
                                    ...
                                    <?php if($item['text']){ ?><div class="text"><?php echo wp_kses($item['text'], true); ?>
                                    </div><?php } ?>
    ...
    <div class="check-availability style-six">
        <div class="form">
			<?php echo do_shortcode($settings['booking_form_url7']); ?>
        </div>
    </div>        
    <?php endif; ?>      
